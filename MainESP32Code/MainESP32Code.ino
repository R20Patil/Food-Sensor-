...
void loop() {
  ...
  // Read sensor values (replace with your sensor reading code)
  ...
  String dataString = "api_key=" + String(apiWriteKey) + "&field1=" + String(phsensor) + "&field2=" + String(color) + "&field3=" + String(turbidity) + "&field4=" + String(methane)+ "&field5=" + String(alcohol);
...
float readPHSensor() {
  // Code to read temperature sensor and return value
  return 25.5;  // Example value
}

char* readColorSensor() {
  // Code to read humidity sensor and return value
